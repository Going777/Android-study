...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sentenceList.add("자기 아이에게 육체적 노동을 가르치지 않는 것은 약탁과 강도를 가르치는 것과 마찬가지다.")
        ...
        sentenceList.add("가는 말이 고와야 오는 말이 곱다.")
        sentenceList.add("낮 말은 새가 듣고 밤 말은 쥐가 듣는다.")

        Log.d("MainActivity - onCreate() called", "안년어어어ㅓ어어ㅓ어엉엉")
